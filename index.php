    ...
    <?php if (isset($_SESSION['user_id'])): ?>
      ...
      <div class="mb-3">
        ...
        <?php else: ?>
          ...
          <a href="viewdiary.php" class="btn btn-info">Read a Random Diary</a>
        <?php endif; ?>
        <a href="logout.php" class="btn btn-outline-dark float-right">Logout</a>
      </div>
    <?php else: ?>
      <p>Please <a href="login.php">log in</a> or <a href="signup.php">sign up</a> to start reading or writing diaries.</p>
    <?php endif; ?>
        ...
        <table class="table table-striped mt-3">
          ...
          <?php while ($row = mysqli_fetch_assoc($result)): ?>
            <tr>
              ...
              <td>
                <a class="nav-link d-inline" href="editdiary.php?id=<?= htmlspecialchars($row['diary_id']) ?>">
                  <i class="fas fa-edit"></i>
                </a>
                <a class="nav-link d-inline" href="deletediary.php?id_to_delete=<?= htmlspecialchars($row['diary_id']) ?>">
